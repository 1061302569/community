package com.chu.community.community.mapper;
...
public interface QuestionMapper {
    ...
    List<Question> listByUserId(@Param( "userId" ) Integer userId,@Param( value = "offset" ) Integer page,@Param( value = "size") Integer size);
