...
import com.chu.community.community.dto.CommentDTO;
import com.chu.community.community.enums.CommentTypeEnum;
...
import com.chu.community.community.mapper.CommentMapper;
...
import com.chu.community.community.model.*;
...
public class CommentService {
    ...
    public void inset(Comment comment) {
        ...
        if (comment.getType() == null && CommentTypeEnum.isExist(comment.getType())){
            throw new CustomizeException( CustomizeErrorCode.TYPE_PARAM_WARNING );
        }
